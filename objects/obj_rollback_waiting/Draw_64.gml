//prepare_text_draw(font, fa_left, fa_top);
//draw_outlined_text(15, 15, "players on room: " + string(players_in_room_count) + "/4");

prepare_text_draw(font, fa_center, fa_center);
draw_outlined_text(gui_width * .5, gui_height * .5 - 170,
	"players on room: " + string(players_in_room_count) + "/4");

//if (!show_text || players_in_room_count == 0)
//	return;
